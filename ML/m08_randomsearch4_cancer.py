...
start = time.time()
model = GridSearchCV(RandomForestClassifier(),params,cv=kfold,verbose=1)
...
acc :  0.9623734177215189
최적의 매개변수  RandomForestClassifier(n_jobs=2)
{'n_jobs': 2}
0.9649122807017544
걸린시간 :  13.145134925842285


Fitting 5 folds for each of 10 candidates, totalling 50 fits
acc :  0.9599367088607595
최적의 매개변수  RandomForestClassifier()
{'n_estimators': 100}
0.9649122807017544
걸린시간 :  7.813319444656372
'''
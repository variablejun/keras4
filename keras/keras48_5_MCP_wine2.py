...
cp = ModelCheckpoint(monitor='accuracy', save_best_only=True,mode='auto', filepath='./_save/ModelCheckpoint/keras47_MCP.hdf5')

model.fit(x_train, y_train, epochs=1000, batch_size=64, validation_split=0.0003, callbacks=[es,cp]) 
...
1/1 [==============================] - 0s 22ms/step - loss: 0.8020 - accuracy: 1.0000
loss :  0.8019983172416687
accuracy :  1.0
